          ...
          <div className="space-y-4">
            {member.metadata.profile_image && (
              <div className="w-32 h-32 mx-auto">
                <img
                  src={`${member.metadata.profile_image.imgix_url}?w=128&h=128&fit=crop&auto=format,compress`}
            ...
            <div className="space-y-2">
              ...
              <p className="text-primary font-medium">{member.metadata.role}</p>
              {member.metadata.bio && (
                <p className="text-gray-600 text-sm">{member.metadata.bio}</p>
              )}
            </div>
            ...
            <div className="flex justify-center space-x-4">
              ...
              {member.metadata.github_url && (
                <a
                  href={member.metadata.github_url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary hover:text-primary-dark"
                  aria-label="GitHub"
